...
export const pillars = [
  {
    ...
    services: [
      {
        name: "Threat & Offensive Testing",
        icon: "clipboard",
        blurb: "Structured threat modeling and posture reviews for critical assets, workloads, data and access paths.",
        chips: ["Threat modeling", "Posture review", "Attack path Analysis"],
      },
      {
        name: "Threat Intelligence",
        icon: "radar",
        blurb: "Dark-web monitoring, credential exposure, actor tracking, and executive briefings.",
        chips: ["Dark-Web Monitoring", "Credential Exposure Monitoring", "Threat Actor Tracking", "Brand Protection"],
      },
      {
        ...
        chips: ["Adversary Emulation", "Purple Teaming", "Breach & Attack Simulation", "Social Engineering"],
      },
      {
        name: "Penetration Testing",
        icon: "terminal",
        blurb: "Scoped ethical hacking with a clear boundary against red-team and vulnerability-scan work.",
        chips: ["Web & API Testing", "Network Penetration Testing", "Cloud Penetration Testing"],
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        chips: ["EDR / XDR", "Firewall", "IDS / IPS", "Network Segmentation"],
      },
      {
        name: "Cloud Native Security",
        icon: "cloud",
        blurb: "CNAPP, CSPM, and CWPP across AWS, Azure, and GCP, including containers and Kubernetes.",
        chips: ["Cloud Security Posture Mgt", "Cloud Workload Protection", "Container & Kubernetes Security"],
      },
      {
        name: "Data Protection",
        icon: "lock",
        blurb: "Classification, DLP, encryption, and key management as one data-security program.",
        chips: ["Data Classification", "Data Loss Prevention (DLP)", "Encryption", "Key Management"],
      },
      {
        name: "AI Security",
        icon: "spark",
      ...
      },
      {
        ...
        chips: ["Asset Inventory", "Network Segmentation", "Security Monitoring", "Secure Change Management"],
      },
      {
        name: "Zero Trust Architecture",
        icon: "hexagon",
        blurb: "Never trust, always verify — micro-segmentation, continuous authentication, identity-centric access.",
        chips: ["Micro-Segmentation", "Continuous Authentication", "Identity-Centric Access", "Reference Architecture"],
      },
    ],
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        chips: ["Security Policies", "Control Framework", "Operating Model", "Decision Rights"],
      },
      {
        name: "Risk Management",
        icon: "gauge",
        blurb: "Enterprise cyber-risk register, scoring, and treatment plans directors can use.",
        chips: ["Register", "Scoring", "Treatment", "Board Report"],
      },
      {
        name: "Audit & Assurance",
        icon: "clipboard",
        blurb: "Readiness, control testing, and evidence collection for the auditor and the board.",
        chips: ["Audit Readiness", "Control Testing", "Evidence Validation", "Findings Remediation"],
      },
      {
        name: "vCISO Services",
        icon: "crown",
        blurb: "Fractional CISO, board reporting, security roadmaps, and vendor arbitration.",
        chips: ["Fractional CISO", "Security Roadmap", "Board Reporting", "Vendor Oversight"],
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        chips: ["Continuous Scanning", "Risk-Based Prioritization", "Remediation Verification", "Ownership & SLA"],
      },
      {
      ...
      },
      {
        ...
        chips: ["CTEM", "Attack Surface Mgt", "Exposure Validation", "Exposure Drift"],
      },
      {
        name: "Remediation Management",
        icon: "wrench",
        blurb: "Ticket orchestration, owner SLAs, and retest so findings actually close.",
        chips: ["Ticket Orchestration", "Ownership & SLA", "Remediation Retesting", "Closure Management"],
      },
    ],
  },
  {
