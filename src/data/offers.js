export const serviceOutcomes = {
  ...
  "Network & Endpoint Security": "Devices and traffic are protected as one surface — not confused with scanning.",
  "Cloud Native Security": "Cloud, containers, and Kubernetes share one posture and protection program.",
  ...
  "Audit & Assurance": "Readiness and evidence the auditor and the board can use.",
  "vCISO Services": "Fractional leadership, a roadmap, and board reporting you can keep.",
  ...
  "Recovery Planning": "Restore objectives security and IT share and can test.",
  "Business Continuity": "Critical processes have a path when systems, sites, or suppliers fail.",
};

export const pillarOutcomes = {
  threat: "You know what can hurt you, from whom, and how hard you have tested that story.",
  secops: "The estate is protected as one operating stack — network, identity, cloud, data, and OT.",
  grc: "Governance, risk, audit, and a vCISO sit in one program the board can hire.",
  exposure: "What is open is found, ranked, and closed — including application security.",
  resilience: "The enterprise can contain, investigate, and continue through an incident.",
};

export const industryFocus = {
  bfsi: ["Payment controls", "SOC 2 evidence", "Board risk packs", "Fraud-adjacent review"],
  health: ["HIPAA alignment", "Clinical resilience", "Privacy operations", "Audit evidence"],
  ot: ["Plant visibility", "Purdue segmentation", "Safe change", "Safety-aware cyber"],
  tech: ["SSDLC", "API testing", "Cloud-native protect", "Product-team AppSec"],
  retail: ["Payment security", "Customer data", "Peak-season readiness", "Incident path"],
  public: ["Governance", "OT for critical services", "Continuity", "Evidence for oversight"],
};

export const motionGets = {
  Assess: ["Threat model", "Attack-surface review", "Fundable risk picture"],
